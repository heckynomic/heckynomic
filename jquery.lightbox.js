...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			lightbox_path+'https://lh5.googleusercontent.com/-KFUBnM-e9JY/TlSJoZPDY5I/AAAAAAAAB44/pm5kS0TpzRU/loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			lightbox_path+'https://lh3.googleusercontent.com/-_skhVXM98sc/TlSJoDLG_fI/AAAAAAAAB48/ySIRu593UFM/prevlabel.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			lightbox_path+'https://lh4.googleusercontent.com/-2MKMiQ-nv70/TlSJomXtiaI/AAAAAAAAB5I/YAeDjk7i1nw/nextlabel.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			lightbox_path+'https://lh3.googleusercontent.com/-Ep6xRGWBruw/TlSJoWcl5pI/AAAAAAAAB40/3eW_tTs-Y2w/closelabel.gif',		// (string) Path and the name of the close btn
			imageBlank:				lightbox_path+'https://lh3.googleusercontent.com/--5GxB8nG_nw/TlSJn7FLAJI/AAAAAAAAB4s/SZ6bgWO1JLw/blank.gif',			// (string) Path and the name of a blank image (one pixel)
